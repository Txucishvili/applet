import { DynamicStoreState } from "./DynamicStore";
...
export var BlockListContexts = new DynamicStoreState<BlockListModel, BlockListDispatchs>('blocklist', initState, (state, { type, payload }) => {
  switch (type) {
    case 'SET':
...
BlockListContexts.onReady = (status) => {
